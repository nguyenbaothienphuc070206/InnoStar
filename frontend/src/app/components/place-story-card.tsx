...
const guideImageMap: Record<PlaceStoryCardProps["persona"], Record<GuideMotionFrame, string>> = {
  driver: {
    idle: "/guides/Taixe1.png",
    up: "/guides/Taixe2.png",
    down: "/guides/Taixe3.png",
    blink: "/guides/Taixe2.png"
  },
  youth: {
    idle: "/guides/Thanhnien1.png",
    up: "/guides/Thanhnien2.png",
    down: "/guides/Thanhnien3.png",
    blink: "/guides/Thanhnien2.png"
  },
  coba: {
    idle: "/guides/coba1.png",
    up: "/guides/coba2.png",
    down: "/guides/coba3.png",
    blink: "/guides/coba2.png"
  }
};
...
export default function PlaceStoryCard({ place, script, persona, onNextStep, isFinished }: PlaceStoryCardProps) {
  ...
  const guideImage = guideImageMap[persona][guideMotion];
